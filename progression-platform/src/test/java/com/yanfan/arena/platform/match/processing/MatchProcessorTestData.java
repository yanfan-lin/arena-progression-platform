...
public final class MatchProcessorTestData {
    ...
    public static ArenaMatchCompleted event(UUID eventId,
                                            UUID matchId,
                                            long winnerTeamId,
                                            MatchMode mode,
    ...
    public static ArenaMatchCompleted.Team eventTeam(long teamId, ArenaMatchCompleted.Player... players) {
        return new ArenaMatchCompleted.Team(teamId, List.of(players));
    }

    // Build one participant with their K/D/A for the match
    public static ArenaMatchCompleted.Player eventPlayer(long playerId, int kills, int deaths, int assists) {
    ...
    public static void insertTeam(JdbcTemplate jdbcTemplate, long teamId, String name, ArenaMode mode, int rating) {
        jdbcTemplate.update(
                """
    ...
    public static void addMember(JdbcTemplate jdbcTemplate, long teamId, long playerId) {
        jdbcTemplate.update(
