...
// Reject inconsistent or unsafe match statistics.
class MatchStatisticsValidatorTest {
    ...
    private ArenaMatchCompleted.Team team(long teamId,
                                          ArenaMatchCompleted.Player... players)
    {
        return new ArenaMatchCompleted.Team(teamId, List.of(players));
    }

    private ArenaMatchCompleted.Player player(long playerId,
                                              int kills,
                                              int deaths,
                                              int assists)
    {
